...
export const ChatInterface = () => {
  ...
  return (
    <div className="w-3/4 mx-auto h-[calc(100vh-2rem)] bg-chat-area-bg flex flex-col border border-border rounded-lg shadow-lg">
      <ChatHeader />

      {/* Backend connection status */}
      {!isBackendConnected && (
        <div className="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded mx-4 mt-2">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
        ...
        {messages.length === 0 && uploadedFiles.length === 0 && (
          <div className="text-center py-20">
            <div className="w-20 h-20 rounded-3xl bg-blue-500 flex items-center justify-center mx-auto mb-6 shadow-lg">
              <Bot className="w-10 h-10 text-white" />
            </div>
            <h3 className="text-3xl font-bold text-gray-800 mb-3">AIDocs</h3>
